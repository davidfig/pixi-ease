...
function startEases()
{
    ...
    face.text.x -= size / 2
    face.text.y -= size / 2
    ease.add(face, { face: { x: 500, y: 500 }}, { repeat: true, reverse: true })
    ...
    ease.target(target, { x: 500, y: target.y }, 0.25, { repeat: true, reverse: true })
    ease.face(box('face'), target, 0.001, { repeat: true, reverse: true })
}
